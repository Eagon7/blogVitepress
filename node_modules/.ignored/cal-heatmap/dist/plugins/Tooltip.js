(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Tooltip = factory(global.Popper));
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$h(fn = input.toString) && !isObject$e(val = call$c(fn, input))) return val;
    if (isCallable$h(fn = input.valueOf) && !isObject$e(val = call$c(fn, input))) return val;
    if (pref !== 'string' && isCallable$h(fn = input.toString) && !isObject$e(val = call$c(fn, input))) return val;
  ...
  */
  ...
  var speciesConstructor$1 = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined$3(S = anObject$7(C)[SPECIES$1]) ? defaultConstructor : aConstructor(S);
  };
  ...
  if (!set || !clear) {
    ...
    // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
      ...
      isCallable$8(global$7.postMessage) &&
  ...
  ***************************************************************************** */
  ...
  var defaultOptions = {
    ...
    text: function text(timestamp, value, dayjsDate) {
  ...
  var Tooltip = /*#__PURE__*/function () {
    ...
    _createClass(Tooltip, [{
      ...
      value: function setup(pluginOptions) {
        ...
        this.popperInstance = core.createPopper(virtualElement, this.root, this.popperOptions);
        if (!this.listenerAttached) {
