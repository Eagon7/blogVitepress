...
function inferDomain$1(channels, f = finite) {
    return channels.length
        ? [
            min$3(channels, ({ value }) => (value === undefined ? value : min$3(value, f))),
            max$3(channels, ({ value }) => (value === undefined ? value : max$3(value, f)))
        ]
        : [0, 1];
}
...
function inferZeroDomain(channels) {
    return [0, channels.length ? max$3(channels, ({ value }) => (value === undefined ? value : max$3(value, finite))) : 1];
}
...
_LegendLite_instances = new WeakSet(), _LegendLite_buildLegend = function _LegendLite_buildLegend() {
  ...
  return selection.attr('width', width).attr('height', height).attr('class', "".concat(DEFAULT_SELECTOR$2.slice(1), "-bg")).attr('rx', radius).attr('ry', radius).attr('x', function (d, i) {
