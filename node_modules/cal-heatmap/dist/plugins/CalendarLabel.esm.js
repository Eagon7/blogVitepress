...
_CalendarLabel_instances = new WeakSet(), _CalendarLabel_buildComputedOptions = function _CalendarLabel_buildComputedOptions() {
  ...
  selection.attr('width', width).attr('height', height).attr('rx', radius && radius > 0 ? radius : null).attr('ry', radius && radius > 0 ? radius : null).attr('x', function (d, i) {
  ...
  selection.attr('text-anchor', textAlign).attr('x', function (d, i) {
...
export { CalendarLabel as default };
